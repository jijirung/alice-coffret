    ...
    render(){
        ...
        return(
            ...
            <div style={design_form}>
                 <form method="post" action="/purchase/modify_ok">
                <input type="hidden" value={posts[0]._id} name="purchaseId"></input>
                ...
                <div style={btn_style}>
                    <div style={btn_cancel}><a style={btn_cancel_link} href="/purchase"> 취소 </a></div>
