    ...
    createTable = () => {
        ...
        for(var i = 0; i <= this.state.posts.length/4; i++){
            if(this.state.posts.length - i*4 != 0){
                ...
                var item = [];
                for(var j = 0;j < k; j++){
                    var linkHref = '/purchase/detail/'  +this.state.posts[i * 4 + j]._id;
                            ...
                            <a className='projectItem_ProjectItemCard' href={linkHref}>
                                ...
                                <div className='projectItem_ProjectItemTextWrapper'>
                                    ...
                                    <div className='projectItem_FundingInfo'>
                                        ...
                                        <span className='projectItem_FundingInfo_money'>후원자: &nbsp; {this.state.posts[i * 4 + j].sponsor.length}</span>
                                            <span className='projectItem_FundingInfo_percent'></span>
                                        </div>
                                        <div>
                                        판매가 : &nbsp;
                                            <span className='projectItem_day'>{this.state.posts[i * 4 + j].price}</span>원
                                            </div>
                                    </div>
                                </div>
